<template>
  <div>
    ...
    <div class="relative">
      ...
      <div class="relative z-10 mx-auto max-w-1300px md:-mt-100px" v-else>
        <div
          class="
            text-white
            p-20px
            px-60px
            bg-blue-00ACD7
            md:min-h-200px md:mx-20px
          "
        >
          <h1 class="text-center uppercase title-1 text-blue-191f6C mb-10px">
            {{ $t("about.aboutour") }}
            <span class="text-white">{{ $t("about.mission") }}</span>
          </h1>
