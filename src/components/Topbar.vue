<template>
  <div>
    ...
    <div class="block md:hidden">
      <div class="flex justify-between cursor-pointer p-20px">
        <img
    ...
    >
      <div class="flex flex-col flex-grow cursor-pointer p-20px">
      ...
      <div class="flex justify-center p-20px bg-gray-666666">
        <a
