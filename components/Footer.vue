    ...
    <div class="justify-between block mx-auto max-w-1300px p-20px md:flex">
      <div class="hidden md:flex">
        ...
        <div>
          ...
          <p class="text-blue-00ACD7 body-4 mt-10px">{{$t("footer.consumer")}}</p>
          <a class="body-4" href="mailto:consumer@rea-sg.com"
            >{{$t("footer.emailconsumer")}}</a
          >
          <p class="text-blue-00ACD7 body-4 mt-10px">{{$t("footer.concierge")}}</p>
          ...
          >
          <p class="text-blue-00ACD7 body-4 mt-10px">{{$t("footer.media")}}</p>
          <a class="body-4" href="mailto:media@rea-sg.com">{{$t("footer.emailmedia")}}</a>
        </div>
      </div>
...
export default {
  data() {
    return {
      ...
      footer: {
        address: [
          this.$t("footer.addressline1"),
          this.$t("footer.addressline2"),
          this.$t("footer.addressline3"),
          this.$t("footer.addressline4"),
        ],
        phone: this.$t("footer.phone")
      },
    };
  },
};
